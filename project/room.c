...
static inline void clearRoom(struct room_definition *room, u8 palette_index)
{
...
static inline void centerRoomTransform(struct room_definition *room, s16 *room_transform_x, s16 *room_transform_y)
{
...
void Room_Load(struct room_definition *room, s16 *room_transform_x, s16 *room_transform_y, u8 palette_index, u8 tilemap_index)
{
	...
	clearRoom(room, palette_index);

	centerRoomTransform(room, room_transform_x, room_transform_y);
